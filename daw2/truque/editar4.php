...
<form action="editarok4.php" method="POST"  enctype= "multipart/form-data">
          ...
          <?= "<textarea name ='truque' cols='40' rows='10'value  echo $retorno->truque; >" .$retorno->truque."</textarea> <br>" ?>
			  ...
			  <br>
			       ...
			       <input type= "hidden" name= "idee" value ="<?php echo $retorno->id_tr;?>" /><br>

             <br>

             Imagem: <input type = "file" name ="imagem" value ="<?php echo $retorno->foto;?>" /><br>
