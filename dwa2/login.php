...
<body >
    ...
    <div class="container">
      <div class="row">
        ...
        <legend> LOGIN </legend>
         ...
         <label> Email:</label> <label><input type = "text" name ="email" required ></label> <br>
          
     
          
         <label> Senha:  </label> <label><input type = "password" name ="senha" required ></label>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright ; Michael Oliveira 2019</p>
    </div>
    <!-- /.container -->
  </footer>
