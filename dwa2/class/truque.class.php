      ...
      class trq { 
		 ...
		 $sql= "INSERT INTO $this->tabela(jogo,truque,datas,id_cate) VALUES ('$this->jogo','$this->truque','$this->datas',$this->id_cate)";
		  ...
		  public function listar($com= "") { 
			...
			while ($res = mysqli_fetch_assoc($resultado) ) {
	         ...
	         $sql=  "SELECT * FROM $this->tabela WHERE id_tr=$this->id_tr";
			  ...
			  $sql = "UPDATE $this->tabela  SET jogo ='$this->jogo' , truque = '$this->truque', datas = '$this->datas' ,id_cate=$this->id_cate  
